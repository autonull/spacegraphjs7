...
type WithDimensions<T> = T & Dimensions;
type WithColorable<T> = T & Colorable;
type WithOpacity<T> = T & Opacity;
type WithThemable<T> = T & Themable;
type WithSize<T> = T & { size?: number };

// ============================================================================
// Node Data Types
// ============================================================================

export interface LabelLodLevel { distance: number; scale?: number; style?: string; }
...
export type GroupNodeData = WithDimensions<WithColorable<WithOpacity<BaseNodeData>>> & {
    depth?: number; wireframe?: boolean; title?: string;
};

export type NoteNodeData = WithDimensions<WithColorable<BaseNodeData>> & {
    text?: string; textColor?: string | number; fontSize?: number;
};
...
export interface EdgeSpec<T extends EdgeData = EdgeData> { id: string; source: string; target: string; type: string; data?: T; }
...
export interface AnimationProps { x?: number; y?: number; z?: number; scale?: number; duration?: number; ease?: string; delay?: number; onUpdate?: () => void; }