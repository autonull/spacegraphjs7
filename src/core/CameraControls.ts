...
export class CameraControls {
  ...
  private setupControls() {
    ...
    }, { passive: false }); // Needs to be false to optionally preventDefault on move
    ...
    canvas.addEventListener('touchmove', (e) => {
      ...
      if (this.activeTouches.size === 1) {
        ...
        this.spherical.radius = Math.max(10, Math.min(5000, this.spherical.radius - (distanceDelta * zoomSpeed)));
