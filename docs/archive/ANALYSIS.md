...
class InteractionSession {
    ...
    finalize(endPos) {
        ...
        return {
            ...
            displacement,
            efficiency:
                displacement > 0 ? displacement / Math.max(this.pathLength, displacement) : 1.0,
...
class CalibrationManager {
    constructor(plugin) {
        this.strategies = [
            {
                name: 'High Precision',
                params: { dampingFactor: 0.2, panSpeed: 0.5, zoomSpeed: 0.6 },
            },
            {
                name: 'High Velocity',
                params: { dampingFactor: 0.05, panSpeed: 1.5, zoomSpeed: 1.5 },
            },
